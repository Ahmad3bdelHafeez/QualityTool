...
FIGMA_CLIENT_ID = os.getenv('FIGMA_CLIENT_ID', 'dnIk38a2HrYxq2maf001hi')
FIGMA_CLIENT_SECRET = os.getenv('FIGMA_CLIENT_SECRET', '8aszkKfY2i7nqymt2GR5JnbHbuAUOi')
FIGMA_REDIRECT_URI = os.getenv('FIGMA_REDIRECT_URI', 'https://qualitytool.onrender.com/callback')
